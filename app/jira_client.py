...
_AC_STOP_HEADERS = {"rationale", "dependencies", "risks", "generated by"}
...
def _parse_acceptance_criteria(text_lines: list[str]) -> list[str]:
    ...
    Stops at the next known section header (Rationale, Dependencies, Risks, footer).
    """
    in_ac = False
    criteria = []
    for line in text_lines:
        ...
        if in_ac:
            ...
            if any(lower.startswith(stop) for stop in _AC_STOP_HEADERS):
                break
